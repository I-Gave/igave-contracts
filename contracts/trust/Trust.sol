 ...
 */
contract Trust is owned, tokenRecipient {
     ...
     * First time setup
     */
    function Trust(Token sharesAddress, uint minutesForDebate, uint allowanceAmount, uint allowanceStart, uint allowanceInterval) payable {
        changeRules(sharesAddress, minutesForDebate, allowanceAmount);
    }
     ...
     */
    function changeRules(uint minutesForDebate, uint allowanceAmount) onlyOwner {
        allowance = allowanceAmount;
        debatingPeriodInMinutes = minutesForDebate;
        ChangeOfRules(debatingPeriodInMinutes, sharesTokenAddress);
    }
        ...
        returns (uint proposalID)
    {
      ...
      // Check if monthly proposal created
