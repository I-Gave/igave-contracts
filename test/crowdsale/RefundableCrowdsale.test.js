...
const RefundableCrowdsale = artifacts.require('IGVCrowdsale');
...
contract('RefundableCrowdsale', function ([_, owner, wallet, investor]) {
  ...
  beforeEach(async function () {
    ...
    this.crowdsale = await RefundableCrowdsale.new(
      this.startTime, this.endTime, rate, goal, goal, wallet, this.token.address, { from: owner }
    );
  ...
  describe('creating a valid crowdsale', function () {
    it('should fail with zero goal', async function () {
      await RefundableCrowdsale.new(
        this.startTime, this.endTime, rate, 0, goal, wallet, this.token.address, { from: owner }
      )
